...
distinct from this service's own inbound ``CFP_S2S_TOKEN``.
...
_SERVICE_ACTOR = "ai-act-conformity-pack"
...
class CloudReviewRouter:
    ...
    def route(self, result: ConformityResult, *, maker: str, tenant: str = "") -> str:
