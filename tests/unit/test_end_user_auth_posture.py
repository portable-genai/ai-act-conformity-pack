...
read
    ...
    bind_profile == local AND profile chosen AND CFP_S2S_TOKEN unset
...
approver's groups and tenant, and ``/v1/assess`` with a real escalated decision written to the
review outbox.
...
from conformity_pack.adapters.local.identity import (
    LocalIdentityAdapter,
)
from conformity_pack.adapters.onprem.identity import (
